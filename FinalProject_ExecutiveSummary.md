# Executive Summary: Food Access Analysis

## I. Research Question
How do food access variables, such as SNAP participation, senior population, and household vehicle access, differ across states and tracts—and how do they relate to social equity and policy planning?

## II. Problem Statement
Food insecurity remains a major public health and social equity concern. This project investigates disparities in food access across demographic and geographic lines using the USDA Food Access Research Atlas dataset.

## III. Data Description
The dataset includes tract-level data across U.S. states from the USDA Food Access Research Atlas. Key features include:
- `TractSNAP`: Number of households receiving SNAP benefits
- `TractSeniors`: Number of seniors per tract
- `TractHUNV`: Households with no vehicle
- `Pop2010`: Tract population from the 2010 Census
- `State`, `County`, and `Urban`: Geographical identifiers
...
Visualizations were generated using Matplotlib and include:
- Top 10 states by average SNAP recipients
- Percent of seniors per state
- Relationships between vehicle ownership and access to food

## VI. Conclusion

This analysis confirms persistent disparities in food access across geographic and socioeconomic lines. Higher SNAP and senior populations cluster in specific states, suggesting targeted policy and infrastructure planning is necessary. The visualization of trends and tract-level data helps local organizations and governments understand food insecurity hotspots.
